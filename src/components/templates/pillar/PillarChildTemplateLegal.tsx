...
export default function PillarChildTemplateLegal({ pageData }: { pageData: PageDataType }) {
    ...
    return (
        <Layout pageData={pageData}>
            ...
            <iframe className="mb-10" src="https://fast.wistia.net/embed/iframe/7e2ympmml6" title="Wistia Video" allow="autoplay; fullscreen" frameBorder="0" scrolling="no" style={{position: 'relative', top: 0, left: 0, width: '850px', height: '478px'}}>
            </iframe>
            </div>
            ...
            <div className="h-full w-full flex flex-col-reverse justify-center lg:grid lg:grid-cols-2 overflow-hidden">
                ...
                <div className={classNames("rounded-tl-[0.9375rem] rounded-tr-[0.9375rem] relative flex items-center justify-center px-9 py-9 pb-16 lg:rounded-br-[1.875rem] lg:rounded-tr-[1.875rem] lg:rounded-tl-[0rem] overflow-hidden", t.classname)}>
                    <div className="lg:w-[27.625rem] flex-col justify-start items-start gap-5 inline-flex">
                        ...
                        <div className=" text-primary-dark text-[2.25rem] font-bold leading-[2.8125rem] lg:leading-[2.375rem] lg:text-[1.875rem]" dangerouslySetInnerHTML={{__html: t.title}} />
                        <div className="text-primary-dark text-base font-normal mb-2 leading-[1.875rem] lg:mb-7" dangerouslySetInnerHTML={{ __html: t.description }} />
                    </div>
                </div>
            </div>
        </Fragment>
