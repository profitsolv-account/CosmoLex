...
export const TabbedSlider: FC<Props> = ({items, tabs, subheading, heading, description, height = '34.375rem'}) => {
    ...
    return <div>
        <div className="container max-w-[66.625rem] mb-16">
            ...
            {description && <div className="text-[0.875rem] text-center text-primary-dark md:text-base font-normal mb-5 md:mb-18" dangerouslySetInnerHTML={{__html: description}} />}
