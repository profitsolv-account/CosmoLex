    ...
    return <div className={classNames("container flex justify-center px-2 pb-10 md:pb-0", className)}>
        <div className="max-w-[46.875rem]">
            <div className="">
                ...
                <h3 className="self-stretch text-center justify-start text-primary-dark text-[2.875rem] font-bold leading-[3.75rem] max-w-[31.25rem] mx-auto">{compareSelector.compareTitle}</h3>
            </div>
            <div className="mt-8">
