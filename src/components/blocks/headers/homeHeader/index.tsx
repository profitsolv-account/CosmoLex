...
export const HomeHeader: FC<Props> = ({pageData, hideRating}) => {
    ...
    return (
        <div className=" px-5 pt-10 mb-15 sm:mb-10 relative">
            <div
                className="flex flex-col gap-0 items-center lg:flex-row lg:gap-10 lg:items-end lg:justify-center lg:max-w-[80rem] lg:mx-auto lg:pb-10 relative z-2">
                <div className="max-w-[24rem] sm:max-w-[40rem] flex flex-col gap-6 lg:max-w-full lg:pb-10">
                    ...
                    <div className="w-full flex justify-center items-center gap-4 lg:justify-start">
                        ...
                        <div
                            className="h-[3.375rem]  px-[0.9375rem] md:px-[1.875rem] pt-5 pb-[1.375rem] bg-white rounded-[6.25rem] border justify-center items-center gap-2.5 inline-flex cursor-pointer transition-all duration-300 group hover:bg-primary hover:text-white">
                            <CustomLink
                    ...
                    <div className="hidden md:block py-5 pb-10">
                        {hideRating ? <div className='gap-4 flex'>
                            <Image
                                src={homeheaderg2}
                                alt="G2"
                                className="h-30 w-auto hidden sm:block"
                                priority={true}
                            />
                            <Image
                ...
                <div
                    className="mt-10 max-w-[40rem] lg:mt-0 lg:max-w-full lg:grow lg:w-[31.4375rem] lg:flex-none xl:w-[43.9375rem] ">
                    <Image
                        src={img}
                        alt="alt"
                        width={700}
