                ...
                <div className="container flex flex-col justify-center items-center gap-4">
                    <div className={classNames("text-center max-w-[56.25rem]", containerClassName)}>
                        ...
                        <div className="pt-6 mb-4">
                            <h1 className="home-title text-white text-[2.875rem] font-medium leading-[3.375rem] lg:text-[3.375rem] xl:text-[3.75rem] xl:leading-[3.75rem] xl:font-normal lg:block tracking-[2.5px]" dangerouslySetInnerHTML={{__html: title}} />
                        </div>

                        {!hideContent && description && <div className="min-h-[3.8125rem] text-center text-white text-[1.25rem] font-normal leading-[2rem] lg:w-full tracking-[.3px]" dangerouslySetInnerHTML={{__html: description}} />}
