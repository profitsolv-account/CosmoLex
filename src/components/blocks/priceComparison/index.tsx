...
export const PriceComparison: FC<Props> = ({settings, plans, title}) => {
    ...
    return <div className="price-comparison pt-20 px-2 relative pb-10">
        <div className="max-w-[1124px] mx-auto relative z-10">
            ...
            <div
                className="bg-green py-5 px-5 rounded-[15px] shadow-[0px_21px_30px_0px_rgba(0,0,0,0.05)] md:rounded-[30px] md:py-[30px] md:px-[29px]">

                <div className="justify-start items-center gap-2.5 inline-flex w-full">

                    <div
                        className="w-[40%] text-primary-dark text-[18px] font-bold flex-none md:text-[28px] md:w-[60%]">Plans
                        & pricing
                    </div>
                    ...
                    <div className="justify-start items-center gap-1 flex grow">
                        ...
                        <div className="flex-col justify-start items-center inline-flex w-1/2">
                            <div
                                className="self-stretch text-center text-primary-dark text-[18px] font-bold md:text-2xl">Standard
                            </div>
                            <div className="text-primary-dark text-[23px] font-bold leading-[60px] md:text-[47px]">$99
                            </div>
                        ...
                        <div className="flex-col justify-start items-center inline-flex w-1/2">
                            <div
                                className="self-stretch text-center text-primary-dark text-[18px] font-bold md:text-2xl">Elite
                            </div>
                            <div
                                className="text-primary-dark text-[23px] font-bold leading-[60px] md:text-[47px]">$129
                            </div>
                            <div className="self-stretch text-center text-primary-dark text-base font-normal">/ Paid
                                annualy
                            </div>
            ...
            <span className="text-[#323d42] text-[14px] font-normal pl-2 md:text-xl text-[#323d42] text-sm font-normal block"/>
        </div>
    </div>
}