...
export const BarAssociations: FC<Props> = ({data}) => {
    ...
    return <div className="px-2">
       <div className="max-w-[1135px] mx-auto">
           ...
           <h3 className="self-stretch text-center justify-start text-[#202b46] text-[46px] font-bold leading-[55px] max-w-[697px] mx-auto mb-10">{data.barTitle}</h3>
           <p className="text-center justify-start text-[#0c193a] text-base font-normal leading-[30px] max-w-[597px] mx-auto">{data.barDescription}</p>
