                ...
                >
                    {
                        dataSliders.map((t, index) => (
                            <SwiperSlide key={`${t.title}_${index}`} className={"w-full lg:!w-[1066px] !flex items-center h-full"}>
                                <div className="test h-full flex flex-col-reverse justify-center mx-auto  relative z-10 slide-content overflow-hidden  transition-all duration-1200 lg:grid lg:h-[550px] lg:grid-cols-2 lg:max-w-[1066px]">
